...
var require_ID3Definitions = __commonJS({
  "node_modules/node-id3/src/ID3Definitions.js"(exports, module2) {
    ...
    var FRAME_INTERNAL_IDENTIFIERS = Object.keys(FRAME_IDENTIFIERS).reduce((acc, versionKey) => {
      acc[versionKey] = Object.keys(FRAME_IDENTIFIERS[versionKey]).reduce((acc2, tagKey) => {
        acc2[FRAME_IDENTIFIERS[versionKey][tagKey]] = tagKey;
        return acc2;
      }, {});
      return acc;
    }, {});
    ...
    module2.exports.APIC_TYPES = APICTypes;
    module2.exports.ENCODINGS = ENCODINGS;
    module2.exports.FRAME_IDENTIFIERS = FRAME_IDENTIFIERS;
    module2.exports.FRAME_INTERNAL_IDENTIFIERS = FRAME_INTERNAL_IDENTIFIERS;
    module2.exports.ID3_FRAME_OPTIONS = ID3_FRAME_OPTIONS;
    module2.exports.TagConstants = TagConstants;
  }
});
...
var require_ID3Util = __commonJS({
  "node_modules/node-id3/src/ID3Util.js"(exports, module2) {
    ...
    module2.exports.SplitBuffer = class SplitBuffer {
      constructor(value = null, remainder = null) {
        this.value = value;
        this.remainder = remainder;
      }
    };
    module2.exports.splitNullTerminatedBuffer = function(buffer, encodingByte = 0) {
    ...
    module2.exports.terminationBuffer = function(encodingByte = 0) {
      if (encodingByte === 1 || encodingByte === 2) {
        return Buffer.alloc(2, 0);
      }
      return Buffer.alloc(1, 0);
    };
    module2.exports.encodingFromStringOrByte = function(encoding) {
    ...
    module2.exports.stringToEncodedBuffer = function(str, encodingByte) {
      return iconv.encode(str, this.encodingFromStringOrByte(encodingByte));
    };
    module2.exports.bufferToDecodedString = function(buffer, encodingByte) {
      return iconv.decode(buffer, this.encodingFromStringOrByte(encodingByte)).replace(/\0/g, "");
    };
    module2.exports.getSpecOptions = function(frameIdentifier) {
      if (ID3Definitions.ID3_FRAME_OPTIONS[frameIdentifier]) {
        return ID3Definitions.ID3_FRAME_OPTIONS[frameIdentifier];
      }
      return {};
    };
    module2.exports.isValidID3Header = function(buffer) {
      if (buffer.length < 10) {
        return false;
      }
      if (buffer.readUIntBE(0, 3) !== 4801587) {
        return false;
      }
      if ([2, 3, 4].indexOf(buffer[3]) === -1 || buffer[4] !== 0) {
        return false;
      }
      return this.isValidEncodedSize(buffer.slice(6, 10));
    };
    module2.exports.getFramePosition = function(buffer) {
      let framePosition = -1;
    ...
    module2.exports.isValidEncodedSize = function(encodedSize) {
      return ((encodedSize[0] | encodedSize[1] | encodedSize[2] | encodedSize[3]) & 128) === 0;
    };
    module2.exports.encodeSize = function(size) {
    ...
    module2.exports.decodeSize = function(encodedSize) {
      return (encodedSize[0] << 21) + (encodedSize[1] << 14) + (encodedSize[2] << 7) + encodedSize[3];
    };
    module2.exports.getFrameSize = function(buffer, decode, ID3Version) {
      let decodeBytes;
      if (ID3Version > 2) {
    ...
    module2.exports.parseTagHeaderFlags = function(header) {
    ...
    module2.exports.parseFrameHeaderFlags = function(header, ID3Version) {
      if (!(header instanceof Buffer && header.length === 10)) {
        return {};
      }
    ...
    module2.exports.processUnsynchronisedBuffer = function(buffer) {
      const newDataArr = [];
      if (buffer.length > 0) {
    ...
    module2.exports.getPictureMimeTypeFromBuffer = function(pictureBuffer) {
      if (pictureBuffer.length > 3 && pictureBuffer.compare(Buffer.from([255, 216, 255]), 0, 3, 0, 3) === 0) {
        return "image/jpeg";
      } else if (pictureBuffer > 8 && pictureBuffer.compare(Buffer.from([137, 80, 78, 71, 13, 10, 26, 10]), 0, 8, 0, 8) === 0) {
        return "image/png";
      } else {
        return null;
      }
...
var require_ID3FrameBuilder = __commonJS({
  "node_modules/node-id3/src/ID3FrameBuilder.js"(exports, module2) {
    module2.exports = ID3FrameBuilder;
    var ID3Util = require_ID3Util();
    function ID3FrameBuilder(identifier) {
      this._identifier = identifier;
      this._buffer = Buffer.alloc(0);
    }
    ID3FrameBuilder.prototype.appendStaticValue = function(value, size, encoding = 0) {
    ...
    ID3FrameBuilder.prototype.appendNullTerminatedValue = function(value, encoding = 0) {
      value = value || "";
      const convertedValue = convertValue(value, encoding);
    ...
    function convertValue(value, encoding = 0) {
    ...
    function staticValueToBuffer(buffer, size) {
      ...
      if (size && buffer.length < size) {
        return Buffer.concat([Buffer.alloc(size - buffer.length, 0), buffer]);
      }
      return buffer;
    }
...
var require_ID3FrameReader = __commonJS({
  "node_modules/node-id3/src/ID3FrameReader.js"(exports, module2) {
    module2.exports = ID3FrameReader;
    var ID3Util = require_ID3Util();
    function ID3FrameReader(buffer, encodingBytePosition, consumeEncodingByte = true) {
      ...
      if (Number.isInteger(encodingBytePosition)) {
        this._encoding = buffer[encodingBytePosition] ? buffer[encodingBytePosition] : 0;
    ...
    function convertValue(buffer, dataType, encoding = 0) {
      if (!buffer) {
        return void 0;
      }
      if (!(buffer instanceof Buffer)) {
    ...
    function nullTerminatedValueFromBuffer(buffer, encoding = 0) {
      return ID3Util.splitNullTerminatedBuffer(buffer, encoding);
    }
  }
});

// node_modules/node-id3/src/util.js
var require_util = __commonJS({
  "node_modules/node-id3/src/util.js"(exports, module2) {
    module2.exports.isFunction = (value) => typeof value === "function";
    module2.exports.isString = (value) => typeof value === "string" || value instanceof String;
  }
});

// node_modules/node-id3/src/ID3Frames.js
var require_ID3Frames = __commonJS({
  "node_modules/node-id3/src/ID3Frames.js"(exports, module2) {
    var fs = require("fs");
    ...
    var { isString } = require_util();
    module2.exports.GENERIC_TEXT = {
    ...
    module2.exports.APIC = {
      create: (data) => {
        try {
          ...
          const pictureTypeId = pictureType.id === void 0 ? TagConstants.PictureType.FRONT_COVER : pictureType.id;
      ...
      read: (buffer, version) => {
        ...
        let mime;
        if (version === 2) {
          mime = reader.consumeStaticValue("string", 3, 0);
        } else {
          mime = reader.consumeNullTerminatedValue("string", 0);
        }
        ...
        return {
          ...
          synchronisedText: Array.from(function* () {
            while (true) {
              ...
              if (text === void 0 || timeStamp === void 0) {
                break;
              }
    ...
    module2.exports.UFID = {
      create: (data) => {
        if (!(data instanceof Array)) {
          data = [data];
        }
        return Buffer.concat(data.map((ufid) => new ID3FrameBuilder("UFID").appendNullTerminatedValue(ufid.ownerIdentifier).appendStaticValue(
          ufid.identifier instanceof Buffer ? ufid.identifier : Buffer.from(ufid.identifier, "utf8")
        ).getBuffer()));
      },
      read: (buffer) => {
        const reader = new ID3FrameReader(buffer);
    ...
    module2.exports.CHAP = {
      ...
      read: (buffer) => {
        ...
        if (chap.startOffsetBytes === 4294967295) {
          delete chap.startOffsetBytes;
        }
        if (chap.endOffsetBytes === 4294967295) {
          delete chap.endOffsetBytes;
        }
        return chap;
      }
    };
    module2.exports.CTOC = {
      create: (data) => {
        if (!(data instanceof Array)) {
          data = [data];
        }
        ...
        return {
          ...
          keyEvents: Array.from(function* () {
            while (true) {
              ...
              const timeStamp = reader.consumeStaticValue("number", 4);
              if (type === void 0 || timeStamp === void 0) {
                break;
              }
      ...
      create: (data) => {
        ...
        return Buffer.concat(data.map((comr) => {
          ...
          builder.appendStaticValue(
            comr.validUntil.year.toString().padStart(4, "0").substring(0, 4) + comr.validUntil.month.toString().padStart(2, "0").substring(0, 2) + comr.validUntil.day.toString().padStart(2, "0").substring(0, 2),
            8,
            0
          );
...
// node_modules/node-id3/src/ID3Helpers.js
var require_ID3Helpers = __commonJS({
  "node_modules/node-id3/src/ID3Helpers.js"(exports, module2) {
    ...
    function createBuffersFromTags(tags) {
      ...
      const rawObject = Object.keys(tags).reduce((acc, val) => {
        if (ID3Definitions.FRAME_IDENTIFIERS.v3[val] !== void 0) {
          acc[ID3Definitions.FRAME_IDENTIFIERS.v3[val]] = tags[val];
        } else if (ID3Definitions.FRAME_IDENTIFIERS.v4[val] !== void 0) {
      ...
      Object.keys(rawObject).forEach((frameIdentifier) => {
        ...
        if (ID3Frames[frameIdentifier] !== void 0) {
    ...
    module2.exports.createBufferFromTags = function(tags) {
      return Buffer.concat(createBuffersFromTags(tags));
    };
    module2.exports.getTagsFromBuffer = function(filebuffer, options) {
    ...
    function decompressFrame(frame) {
      if (frame.body.length < 5 || frame.dataLengthIndicator === void 0) {
        return null;
      }
    ...
    module2.exports.getTagsFromID3Body = function(body) {
...
var require_node_id3 = __commonJS({
  "node_modules/node-id3/index.js"(exports, module2) {
    var fs = require("fs");
    var ID3Definitions = require_ID3Definitions();
    var ID3Util = require_ID3Util();
    var ID3Helpers = require_ID3Helpers();
      ...
      if (isString(filebuffer)) {
        try {
          fs.readFile(filebuffer, (error, data) => {
            ...
            fs.writeFile(filebuffer, newData, "binary", (error2) => {
              fn(error2);
            });
          });
        } catch (error) {
    ...
    function read3(filebuffer, options, fn) {
    ...
    function update3(tags, filebuffer, options, fn) {
      if (!options || typeof options === "function") {
        fn = fn || options;
        options = {};
      }
      ...
      const updateFn = (currentTags) => {
        ...
        Object.keys(rawTags).map((frameIdentifier) => {
          const options2 = ID3Util.getSpecOptions(frameIdentifier, 3);
          const cCompare = {};
          if (options2.multiple && currentTags[frameIdentifier] && rawTags[frameIdentifier]) {
            if (options2.updateCompareKey) {
              currentTags[frameIdentifier].forEach((cTag, index) => {
                cCompare[cTag[options2.updateCompareKey]] = index;
              });
            }
            ...
            rawTags[frameIdentifier].forEach((rTag) => {
              const comparison = cCompare[rTag[options2.updateCompareKey]];
      ...
      if (isFunction(fn)) {
        return write(updateFn(read3(filebuffer, options)), filebuffer, fn);
      }
      return write(updateFn(read3(filebuffer, options)), filebuffer);
    }
    ...
    function removeTagsAsync(filepath, fn) {
      fs.readFile(filepath, (error, data) => {
        ...
        fs.writeFile(filepath, newData, "binary", (error2) => {
          if (error2) {
            fn(error2);
          } else {
            fn(null);
    ...
    function makePromise(fn, reorderParameters = (fn2) => (a, b) => fn2(a, b)) {
    ...
    var PromiseExport = {
      ...
      update: (tags, file, options) => makePromise(update3.bind(null, tags, file, options)),
      read: (file, options) => makePromise(read3.bind(null, file, options)),
...
// node_modules/jsmediatags/build2/StringUtils.js
var require_StringUtils = __commonJS({
  "node_modules/jsmediatags/build2/StringUtils.js"(exports, module2) {
    "use strict";
    ...
    var InternalDecodedString = /* @__PURE__ */ function() {
      function InternalDecodedString2(value, bytesReadCount) {
        _classCallCheck(this, InternalDecodedString2);
      ...
      _createClass(InternalDecodedString2, [{
        key: "toString",
        value: function toString() {
          return this._value;
        }
      }]);
      return InternalDecodedString2;
    }();
    var StringUtils = {
      ...
      readUTF8String: function readUTF8String(bytes, maxBytes) {
        ...
        for (var j = 0; ix < maxBytes; j++) {
          ...
          if (byte1 == 0) {
            ...
            var byte2 = bytes[ix++];
            var byte3 = bytes[ix++];
            arr[j] = String.fromCharCode(((byte1 & 255) << 12) + ((byte2 & 63) << 6) + (byte3 & 63));
          } else if (byte1 >= 240 && byte1 < 245) {
            var byte2 = bytes[ix++];
            var byte3 = bytes[ix++];
            var byte4 = bytes[ix++];
            var codepoint = ((byte1 & 7) << 18) + ((byte2 & 63) << 12) + ((byte3 & 63) << 6) + (byte4 & 63) - 65536;
            arr[j] = String.fromCharCode((codepoint >> 10) + 55296, (codepoint & 1023) + 56320);
          }
        }
        return new InternalDecodedString(arr.join(""), ix);
      },
    ...
    module2.exports = StringUtils;
  }
});

// node_modules/jsmediatags/build2/MediaFileReader.js
var require_MediaFileReader = __commonJS({
  "node_modules/jsmediatags/build2/MediaFileReader.js"(exports, module2) {
    "use strict";
    function _classCallCheck(instance2, Constructor) {
      if (!(instance2 instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    ...
    var MediaFileReader = /* @__PURE__ */ function() {
      function MediaFileReader2(path) {
        _classCallCheck(this, MediaFileReader2);
        _defineProperty(this, "_isInitialized", void 0);
        _defineProperty(this, "_size", void 0);
        this._isInitialized = false;
        this._size = 0;
      }
      _createClass(MediaFileReader2, [{
        key: "init",
        value: (
          /**
      ...
      return MediaFileReader2;
    }();
    module2.exports = MediaFileReader;
  }
});

// node_modules/jsmediatags/build2/ChunkedFileData.js
var require_ChunkedFileData = __commonJS({
  "node_modules/jsmediatags/build2/ChunkedFileData.js"(exports, module2) {
    "use strict";
    function _classCallCheck(instance2, Constructor) {
      if (!(instance2 instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    ...
    var ChunkedFileData = /* @__PURE__ */ function() {
      function ChunkedFileData2() {
        _classCallCheck(this, ChunkedFileData2);
        _defineProperty(this, "_fileData", void 0);
        this._fileData = [];
      }
      _createClass(ChunkedFileData2, [{
        key: "addData",
        value: function addData(offset, data) {
          ...
          if (chunkRange.startIx === NOT_FOUND) {
            ...
            if (needsPrepend) {
              ...
              chunk2.data = this._concatData(slicedData, data);
            }
            if (needsAppend) {
              var slicedData = this._sliceData(chunk2.data, 0, lastChunk.offset - chunk2.offset);
              chunk2.data = this._concatData(slicedData, lastChunk.data);
            }
            this._fileData.splice(chunkRange.startIx, chunkRange.endIx - chunkRange.startIx + 1, chunk2);
          }
        }
      }, {
        key: "_concatData",
        ...
        value: function hasDataRange(offsetStart, offsetEnd) {
          for (var i = 0; i < this._fileData.length; i++) {
            var chunk2 = this._fileData[i];
            if (offsetEnd < chunk2.offset) {
              return false;
            }
            if (offsetStart >= chunk2.offset && offsetEnd < chunk2.offset + chunk2.data.length) {
              return true;
            }
          }
          return false;
      ...
      return ChunkedFileData2;
    }();
    module2.exports = ChunkedFileData;
  }
});

// node_modules/xhr2/lib/browser.js
var require_browser = __commonJS({
  "node_modules/xhr2/lib/browser.js"(exports, module2) {
    module2.exports = XMLHttpRequest;
  }
});

// node_modules/jsmediatags/build2/XhrFileReader.js
var require_XhrFileReader = __commonJS({
  "node_modules/jsmediatags/build2/XhrFileReader.js"(exports, module2) {
    "use strict";
    ...
    var XhrFileReader = /* @__PURE__ */ function(_MediaFileReader) {
      _inherits(XhrFileReader2, _MediaFileReader);
      var _super = _createSuper(XhrFileReader2);
      function XhrFileReader2(url) {
        var _this;
        _classCallCheck(this, XhrFileReader2);
      ...
      _createClass(XhrFileReader2, [{
        key: "_init",
        value: function _init(callbacks) {
          if (XhrFileReader2._config.avoidHeadRequests) {
        ...
        value: function _fetchSizeWithHeadRequest(callbacks) {
          ...
          this._makeXHRRequest("HEAD", null, {
            onSuccess: function onSuccess(xhr) {
              var contentLength = self2._parseContentLength(xhr);
              if (contentLength) {
        ...
        value: function _fetchSizeWithGetRequest(callbacks) {
          ...
          this._makeXHRRequest("GET", range, {
            onSuccess: function onSuccess(xhr) {
              var contentRange = self2._parseContentRange(xhr);
              var data = self2._getXhrResponseContent(xhr);
              if (contentRange) {
        ...
        value: function loadRange(range, callbacks) {
          var self2 = this;
          if (self2._fileData.hasDataRange(range[0], Math.min(self2._size, range[1]))) {
            setTimeout(callbacks.onSuccess, 1);
            return;
          }
        ...
        value: function _makeXHRRequest(method, range, callbacks) {
          ...
          var onXHRLoad = function onXHRLoad2() {
          ...
          if (XhrFileReader2._config.timeoutInSec) {
            xhr.timeout = XhrFileReader2._config.timeoutInSec * 1e3;
        ...
        value: function _setRequestHeader(xhr, headerName, headerValue) {
          if (XhrFileReader2._config.disallowedXhrHeaders.indexOf(headerName.toLowerCase()) < 0) {
        ...
        value: function _createXHRObject() {
          if (typeof window === "undefined" && !this._isWebWorker()) {
            return new (require_browser()).XMLHttpRequest();
          }
    ...
    module2.exports = XhrFileReader;
  }
});

// node_modules/jsmediatags/build2/BlobFileReader.js
var require_BlobFileReader = __commonJS({
  "node_modules/jsmediatags/build2/BlobFileReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var BlobFileReader = /* @__PURE__ */ function(_MediaFileReader) {
      _inherits(BlobFileReader2, _MediaFileReader);
      var _super = _createSuper(BlobFileReader2);
      function BlobFileReader2(blob) {
        var _this;
        _classCallCheck(this, BlobFileReader2);
        _this = _super.call(this);
      ...
      return BlobFileReader2;
    }(MediaFileReader);
    module2.exports = BlobFileReader;
  }
});

// node_modules/jsmediatags/build2/ArrayFileReader.js
var require_ArrayFileReader = __commonJS({
  "node_modules/jsmediatags/build2/ArrayFileReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var ArrayFileReader = /* @__PURE__ */ function(_MediaFileReader) {
      _inherits(ArrayFileReader2, _MediaFileReader);
      var _super = _createSuper(ArrayFileReader2);
      function ArrayFileReader2(array) {
        var _this;
        _classCallCheck(this, ArrayFileReader2);
        _this = _super.call(this);
      ...
      _createClass(ArrayFileReader2, [{
        key: "init",
        value: function init2(callbacks) {
      ...
      return ArrayFileReader2;
    }(MediaFileReader);
    module2.exports = ArrayFileReader;
  }
});

// node_modules/jsmediatags/build2/MediaTagReader.js
var require_MediaTagReader = __commonJS({
  "node_modules/jsmediatags/build2/MediaTagReader.js"(exports, module2) {
    "use strict";
    function _classCallCheck(instance2, Constructor) {
      if (!(instance2 instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    ...
    var MediaTagReader = /* @__PURE__ */ function() {
      ...
      _createClass(MediaTagReader2, [{
        ...
        key: "read",
        value: function read3(callbacks) {
          var self2 = this;
          this._mediaFileReader.init({
            onSuccess: function onSuccess() {
              self2._loadData(self2._mediaFileReader, {
                onSuccess: function onSuccess2() {
                  try {
                    var tags = self2._parseData(self2._mediaFileReader, self2._tags);
                  } catch (ex) {
                    if (callbacks.onError) {
                      callbacks.onError({
                        "type": "parseData",
      ...
      return MediaTagReader2;
    }();
    module2.exports = MediaTagReader;
  }
});

// node_modules/jsmediatags/build2/ID3v1TagReader.js
var require_ID3v1TagReader = __commonJS({
  "node_modules/jsmediatags/build2/ID3v1TagReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var ID3v1TagReader = /* @__PURE__ */ function(_MediaTagReader) {
      _inherits(ID3v1TagReader2, _MediaTagReader);
      var _super = _createSuper(ID3v1TagReader2);
      function ID3v1TagReader2() {
        _classCallCheck(this, ID3v1TagReader2);
        return _super.apply(this, arguments);
      }
      _createClass(ID3v1TagReader2, [{
        key: "_loadData",
        value: function _loadData(mediaFileReader, callbacks) {
    ...
    module2.exports = ID3v1TagReader;
  }
});

// node_modules/jsmediatags/build2/ID3v2FrameReader.js
var require_ID3v2FrameReader = __commonJS({
  "node_modules/jsmediatags/build2/ID3v2FrameReader.js"(exports, module2) {
    "use strict";
    function _classCallCheck(instance2, Constructor) {
      if (!(instance2 instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    ...
    var ID3v2FrameReader = /* @__PURE__ */ function() {
      function ID3v2FrameReader2() {
        _classCallCheck(this, ID3v2FrameReader2);
      }
      _createClass(ID3v2FrameReader2, null, [{
        ...
        value: function readFrames(offset, end, data, id3header, tags) {
          ...
          while (
            ...
            var readFrameFunc = ID3v2FrameReader2.getFrameReaderFunction(frameId);
    ...
    module2.exports = ID3v2FrameReader;
  }
});

// node_modules/jsmediatags/build2/ID3v2TagReader.js
var require_ID3v2TagReader = __commonJS({
  "node_modules/jsmediatags/build2/ID3v2TagReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var ID3v2TagReader = /* @__PURE__ */ function(_MediaTagReader) {
      _inherits(ID3v2TagReader2, _MediaTagReader);
      var _super = _createSuper(ID3v2TagReader2);
      function ID3v2TagReader2() {
        _classCallCheck(this, ID3v2TagReader2);
        return _super.apply(this, arguments);
      }
      _createClass(ID3v2TagReader2, [{
        key: "_loadData",
        value: function _loadData(mediaFileReader, callbacks) {
    ...
    module2.exports = ID3v2TagReader;
  }
});

// node_modules/jsmediatags/build2/MP4TagReader.js
var require_MP4TagReader = __commonJS({
  "node_modules/jsmediatags/build2/MP4TagReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var MP4TagReader = /* @__PURE__ */ function(_MediaTagReader) {
      _inherits(MP4TagReader2, _MediaTagReader);
      var _super = _createSuper(MP4TagReader2);
      function MP4TagReader2() {
        _classCallCheck(this, MP4TagReader2);
        return _super.apply(this, arguments);
      }
      _createClass(MP4TagReader2, [{
        key: "_loadData",
        value: function _loadData(mediaFileReader, callbacks) {
          var self2 = this;
        ...
        value: function _loadAtom(mediaFileReader, offset, parentAtomFullName, callbacks) {
          ...
          var atomName2 = mediaFileReader.getStringAt(offset + 4, 4);
          if (this._isContainerAtom(atomName2)) {
            if (atomName2 == "meta") {
              offset += 4;
            }
            var atomFullName = (parentAtomFullName ? parentAtomFullName + "." : "") + atomName2;
        ...
        value: function _isContainerAtom(atomName2) {
          return ["moov", "udta", "meta", "ilst"].indexOf(atomName2) >= 0;
        }
      }, {
        key: "_canReadAtom",
        value: function _canReadAtom(atomName2) {
          return atomName2 !== "----";
        }
      }, {
        key: "_parseData",
        ...
        value: function _readAtom(tags, data, offset, length, tagsToRead, parentAtomFullName, indent) {
          ...
          while (seek < offset + length) {
            ...
            var atomName2 = data.getStringAt(seek + 4, 4);
            if (this._isContainerAtom(atomName2)) {
              if (atomName2 == "meta") {
                seek += 4;
              }
            ...
            if ((!tagsToRead || tagsToRead.indexOf(atomName2) >= 0) && parentAtomFullName === "moov.udta.meta.ilst" && this._canReadAtom(atomName2)) {
              tags[atomName2] = this._readMetadataAtom(data, seek);
            }
            seek += atomSize;
          }
        }
        ...
        value: function _readMetadataAtom(data, offset) {
          ...
          var atomName2 = data.getStringAt(offset + 4, 4);
          ...
          return {
            id: atomName2,
            size: atomSize,
            description: ATOM_DESCRIPTIONS[atomName2] || "Unknown",
            data: atomData
          };
        }
      }, {
    ...
    module2.exports = MP4TagReader;
  }
});

// node_modules/jsmediatags/build2/FLACTagReader.js
var require_FLACTagReader = __commonJS({
  "node_modules/jsmediatags/build2/FLACTagReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var FLACTagReader = /* @__PURE__ */ function(_MediaTagReader) {
      _inherits(FLACTagReader2, _MediaTagReader);
      var _super = _createSuper(FLACTagReader2);
      function FLACTagReader2() {
        var _this;
        _classCallCheck(this, FLACTagReader2);
      ...
      return FLACTagReader2;
    }(MediaTagReader);
    module2.exports = FLACTagReader;
  }
});

// node_modules/jsmediatags/build2/ReactNativeFileReader.js
var require_ReactNativeFileReader = __commonJS({
  "node_modules/jsmediatags/build2/ReactNativeFileReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var ReactNativeFileReader = /* @__PURE__ */ function(_MediaFileReader) {
      _inherits(ReactNativeFileReader2, _MediaFileReader);
      var _super = _createSuper(ReactNativeFileReader2);
      function ReactNativeFileReader2(path) {
        var _this;
        _classCallCheck(this, ReactNativeFileReader2);
        _this = _super.call(this);
      ...
      _createClass(ReactNativeFileReader2, [{
        key: "getByteAt",
        value: function getByteAt(offset) {
          return this._fileData.getByteAt(offset);
        }
        ...
        value: function _init(callbacks) {
          var self2 = this;
          RNFS.stat(self2._path).then(function(statResult) {
            self2._size = statResult.size;
            callbacks.onSuccess();
        ...
        value: function loadRange(range, callbacks) {
          ...
          RNFS.read(this._path, length, range[0], {
            ...
            var buffer = new Buffer2(readData, "base64");
      ...
      return ReactNativeFileReader2;
    }(MediaFileReader);
    module2.exports = ReactNativeFileReader;
  }
});

// node_modules/jsmediatags/build2/NodeFileReader.js
var require_NodeFileReader = __commonJS({
  "node_modules/jsmediatags/build2/NodeFileReader.js"(exports, module2) {
    "use strict";
    function _typeof(obj) {
      "@babel/helpers - typeof";
      if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    ...
    var NodeFileReader = /* @__PURE__ */ function(_MediaFileReader) {
      _inherits(NodeFileReader2, _MediaFileReader);
      var _super = _createSuper(NodeFileReader2);
      function NodeFileReader2(path) {
        var _this;
        _classCallCheck(this, NodeFileReader2);
        _this = _super.call(this);
        _defineProperty(_assertThisInitialized(_this), "_path", void 0);
        _defineProperty(_assertThisInitialized(_this), "_fileData", void 0);
        _this._path = path;
      ...
      _createClass(NodeFileReader2, [{
        ...
        value: function _init(callbacks) {
          var self2 = this;
          fs.stat(self2._path, function(err, stats) {
            if (err) {
              if (callbacks.onError) {
                callbacks.onError({
                  "type": "fs",
        ...
        value: function loadRange(range, callbacks) {
          ...
          var readData = function readData2(err, _fd) {
            if (err) {
              onError({
                "type": "fs",
                "info": err
          ...
          var processData = function processData2(err, bytesRead, buffer) {
          ...
          var storeBuffer = function storeBuffer2(buffer) {
            var data = Array.prototype.slice.call(buffer, 0, length);
            fileData.addData(range[0], data);
          };
          fs.open(this._path, "r", void 0, readData);
        }
      }], [{
        key: "canReadFile",
        value: function canReadFile(file) {
      ...
      return NodeFileReader2;
    }(MediaFileReader);
    module2.exports = NodeFileReader;
  }
});

// node_modules/jsmediatags/build2/jsmediatags.js
var require_jsmediatags = __commonJS({
  "node_modules/jsmediatags/build2/jsmediatags.js"(exports, module2) {
    "use strict";
    function _classCallCheck(instance2, Constructor) {
      if (!(instance2 instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    ...
    var mediaTagReaders = [];
    function read3(location, callbacks) {
    ...
    var Reader = /* @__PURE__ */ function() {
      ...
      _createClass(Reader2, [{
        ...
        key: "read",
        value: function read4(callbacks) {
          var FileReader2 = this._getFileReader();
          var fileReader = new FileReader2(this._file);
          var self2 = this;
          fileReader.init({
            onSuccess: function onSuccess() {
              self2._getTagReader(fileReader, {
                onSuccess: function onSuccess2(TagReader) {
                  new TagReader(fileReader).setTagsToRead(self2._tagsToRead).read(callbacks);
                },
                onError: callbacks.onError
              });
            },
          ...
          var loadTagIdentifiersCallbacks = {
            onSuccess: function onSuccess() {
              ...
              for (var i2 = 0; i2 < mediaTagReaders.length; i2++) {
                ...
                try {
                  var tagIndentifier = fileReader.getBytesAt(range2.offset >= 0 ? range2.offset : range2.offset + fileSize, range2.length);
                } catch (ex) {
                  if (callbacks.onError) {
                    callbacks.onError({
                      "type": "fileReader",
    ...
    if (typeof process !== "undefined" && !process.browser) {
      if (typeof navigator !== "undefined" && navigator.product === "ReactNative") {
        ReactNativeFileReader = require_ReactNativeFileReader();
        Config.addFileReader(ReactNativeFileReader);
      } else {
        NodeFileReader = require_NodeFileReader();
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("timeupdate" in $$props2)
      $$invalidate(8, timeupdate = $$props2.timeupdate);
    if ("onended" in $$props2)
      $$invalidate(9, onended = $$props2.onended);
    if ("onError" in $$props2)
      $$invalidate(10, onError = $$props2.onError);
    if ("time" in $$props2)
      $$invalidate(0, time = $$props2.time);
    if ("onPlay" in $$props2)
      $$invalidate(11, onPlay = $$props2.onPlay);
    if ("onPause" in $$props2)
      $$invalidate(12, onPause = $$props2.onPause);
  };
  return [
    time,
    src,
...
var AbstractLyricsRenderer = class {
  ...
  static containsMarkdown(content) {
    return /[*_`~[\]]#]/.test(content);
  }
  /** 渲染一行文本：仅当含 Markdown 标记时才走 MarkdownRenderer，否则纯文本直出 */
  async renderText(el, content, path, component) {
    if (content && AbstractLyricsRenderer.containsMarkdown(content)) {
      await import_obsidian.MarkdownRenderer.render(this.app, content, el, path, component);
    } else {
      el.setText(content);
    }
  }
...
// src/renderers/wordSplitter.ts
var WORD_SPLIT_REGEX = /[؀-ۿݐ-ݿࢠ-ࣿﹰ-﻿ऀ-ॿ฀-๿ༀ-࿿一-鿿㐀-䶿぀-ゟ゠-ヿ가-힯㄰-㆏]|[a-zA-Z0-9Ѐ-ӿ԰-֏Ⴀ-ჿ]+|\s+/g;
...
var _LrcRenderer = class extends AbstractLyricsRenderer {
   ...
   */
  static extractPreciseWords(text) {
    ...
    if (s.length > 0) {
      ...
      if (karaoke) {
        for (let i = 0; i < parsed.length; i++) {
          ...
          const precise = _LrcRenderer.extractPreciseWords(text);
  ...
  parse(content) {
    ...
    for (const parts of this.chunk(lines, 7)) {
      ...
      if (line.text) {
        ...
        const precise = _LrcRenderer.extractPreciseWords(line.text);
        if (precise && precise.words.length > 0) {
      ...
      if (blocks.length > 0) {
        let mdEl = await Promise.all(
          this.chunk(blocks, 4).map((parts) => {
            if (parts.length < 4)
              return Promise.resolve(container.createSpan());
...
var _LyricsMarkdownRender = class extends import_obsidian5.MarkdownRenderChild {
  constructor(plugin, source, container, ctx) {
    ...
    this.updateTimestamp = (sec, seek = false) => {
      ...
      const hl = this.binarySearch(lyrics, Math.round(sec * 1e3));
      const hlChanged = hl !== this.currentHL;
      if (hlChanged) {
        if (this.player && this.sentenceMode && !this.player.paused() && this.currentHL != -1 && !seek) {
          this.player.pause();
        }
        this.currentHL = hl;
    ...
    if (this.audioPath) {
      ...
      this.player = new Player_default({
        ...
        props: {
          ...
          onPlay: () => {
            this.plugin.markPlayerActive(this.path);
            this.emitState();
          },
          onPause: () => {
            this.plugin.onRendererPaused(this.path);
          },
          onended: () => {
  ...
  emitState() {
    var _a, _b, _c, _d;
    if (!this.plugin.isStateSource(this.path))
      return;
...
function extractFlacLyrics(bytes) {
  try {
...
function findDataText(b, start, end) {
  let offset = start;
  while (offset + 8 <= end) {
    ...
    if (atomName(b, offset + 4) === "data") {
      ...
      if (textStart < offset + size)
        return decodeUtf8(b.slice(textStart, offset + size));
      return null;
    }
    offset += size;
  }
...
function concatOggData(b) {
  const parts = [];
  let offset = 0;
  let guard = 0;
  while (offset + 27 <= b.length && guard < 64) {
    if (b[offset] !== 79 || b[offset + 1] !== 103 || b[offset + 2] !== 103 || b[offset + 3] !== 83)
      break;
    ...
    for (let i = 0; i < pageSegments; i++)
      segTotal += segTable[i];
    for (let i = 0; i < segTotal && dataStart + i < b.length; i++)
      parts.push(b[dataStart + i]);
...
function parseComments(data, start) {
...
function extractOggTags(bytes) {
  try {
    const b = bytes instanceof Uint8Array ? bytes : new Uint8Array(bytes);
    if (b.length < 27)
      return null;
    const data = concatOggData(b);
    const vorbisIdx = indexOfBytes(data, [3, 118, 111, 114, 98, 105, 115]);
    const opusIdx = indexOfBytes(data, [79, 112, 117, 115, 84, 97, 103, 115]);
    ...
    if (al)
      out.album = al;
    const y = get("DATE") || get("YEAR");
    if (y)
      out.year = y;
    const g = get("GENRE");
    if (g)
      out.genre = g;
    const l = get("LYRICS") || get("UNSYNCEDLYRICS");
    if (l)
      out.lyrics = l;
...
function extractOggLyrics(bytes) {
  var _a, _b;
...
var Mp3PlayerRender = class {
  ...
  async reloadLyrics() {
    ...
    this.currentHL = -1;
    const t = (_b = (_a = this.player) == null ? void 0 : _a.getTimeStamp()) != null ? _b : 0;
    this.updateHighlight(t);
    this.emitState();
  }
  /** 外部改动 MP3 文件后检测 mtime 变化，有变化才重读内嵌歌词（避免每次重扫都全量读文件） */
  async reloadLyricsIfChanged() {
    let mtime = 0;
    try {
      if (this.audioSource.type === "vault" && this.audioSource.file) {
        mtime = this.audioSource.file.stat.mtime;
  ...
  updateHighlight(sec) {
    ...
    while (lo <= hi) {
      ...
      const t = (_a = this.lyricsLines[mid].timestamp) != null ? _a : 0;
      if (t <= timeMs) {
        result = mid;
        lo = mid + 1;
      } else {
  ...
  emitState() {
    ...
    this.plugin.updateLyricsState({
      ...
      actor: this.actor || void 0,
      duration: ((_b = this.player) == null ? void 0 : _b.getDuration()) || 0,
      sourceKind: "mp3"
    });
  }
  async onunload() {
...
var LyricsSettings = class extends import_obsidian6.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian6.Setting(containerEl).setName("\u81EA\u52A8\u6EDA\u52A8").setDesc("\u9ED8\u8BA4\u5173\u95ED\uFF0CLRC\u7B14\u8BB0\u9875\u968F\u64AD\u653E\u8FDB\u5EA6\u6EDA\u52A8").addToggle((toggle) => {
      toggle.setValue(this.settings.autoScroll);
      toggle.onChange((value) => {
        this.updateSettings({ autoScroll: value });
      });
    });
    new import_obsidian6.Setting(containerEl).setName("\u9010\u53E5\u6A21\u5F0F").setDesc("\u9ED8\u8BA4\u5173\u95ED\uFF0C\u6BCF\u53E5\u7ED3\u675F\u540E\u81EA\u52A8\u6682\u505C\uFF0C\u9002\u5408\u8DDF\u8BFB").addToggle((toggle) => {
      toggle.setValue(this.settings.sentenceMode);
      toggle.onChange((value) => {
        this.updateSettings({ sentenceMode: value });
      });
    });
    new import_obsidian6.Setting(containerEl).setName("\u9010\u5B57\u9AD8\u4EAE").setDesc("\u9ED8\u8BA4\u5173\u95ED\uFF0C\u6BCF\u53E5\u5747\u5206\u9010\u5B57\u9AD8\u4EAE\u3002\u652F\u6301\u7CBE\u786E\u9010\u5B57\u9AD8\u4EAE\uFF1A\u5982<00:12.167>\u6CA7<00:13.000>\u6D77").addToggle((toggle) => {
      toggle.setValue(this.settings.karaoke);
      toggle.onChange((value) => {
        this.updateSettings({ karaoke: value });
      });
    });
    new import_obsidian6.Setting(containerEl).setName("\u540E\u53F0\u64AD\u653E").setDesc("\u9ED8\u8BA4\u5173\u95ED\uFF0C\u5F00\u542F\u540E\u6700\u5C0F\u5316\u53EF\u7EE7\u7EED\u64AD\u653E\uFF0C\u4F46\u6CE8\u610F\u5728LRC\u7B14\u8BB0\u8DEF\u5F84\u4E0B\u5207\u6B4C\u65F6\u4F1A\u95EA\u73B0\u5F39\u7A97").addToggle((toggle) => {
      toggle.setValue(this.settings.flashSwitch);
      toggle.onChange((value) => {
        this.updateSettings({ flashSwitch: value });
      });
    });
    new import_obsidian6.Setting(containerEl).setName("\u6B4C\u5355").setHeading();
    new import_obsidian6.Setting(containerEl).setName("\u6B4C\u5355\u6765\u6E90").setDesc("\u9009\u62E9\u6B4C\u5355\u6570\u636E\u6765\u6E90\uFF1ALRC \u7B14\u8BB0\u8DEF\u5F84 \u6216 \u97F3\u9891\u6587\u4EF6\u8DEF\u5F84").addDropdown((dropdown) => {
    ...
    if (this.settings.songSource === "notes") {
      ...
      this.createFolderPicker(containerEl, {
        ...
        onChange: (folder) => {
          this.updateSettings({ audioFolder: folder });
        }
      });
    }
    new import_obsidian6.Setting(containerEl).setName("\u5173\u4E8E").setHeading();
  ...
  createFolderPicker(containerEl, opts) {
    const setting = new import_obsidian6.Setting(containerEl).setName(opts.name).setDesc(opts.desc);
    ...
    const showSuggestions = (query) => {
      ...
      const filtered = (query ? allFolders.filter((f) => f.toLowerCase().includes(lowerQuery)) : allFolders).slice(0, 20);
...
async function resolveAudioSource(app, notePath) {
  ...
  const raw = (_b = (_a = m == null ? void 0 : m.groups) == null ? void 0 : _a.audio) == null ? void 0 : _b.trim();
  if (!raw)
    return null;
...
async function readFileBuffer(app, source) {
  try {
    if (source.type === "vault" && source.file)
      return new Uint8Array(await app.vault.readBinary(source.file));
...
async function writeFileBuffer(app, source, data) {
  try {
    if (source.type === "vault" && source.file) {
...
async function readMp3TagHead(app, source) {
  try {
    const fs = window.require("fs");
    let fullPath = null;
    if (source.type === "external" && source.path) {
    ...
    try {
      ...
      if (head[0] !== 73 || head[1] !== 68 || head[2] !== 51)
        return null;
      const tagSize = (head[6] & 127) << 21 | (head[7] & 127) << 14 | (head[8] & 127) << 7 | head[9] & 127;
      if (tagSize <= 0 || tagSize > 1e7)
        return null;
...
async function writeMp3Tags(app, source, tags) {
  ...
  if (tags.year !== void 0)
    patch.year = tags.year;
  if (tags.comment !== void 0)
    patch.comment = tags.comment === "" ? "" : { language: "eng", text: tags.comment };
  if (tags.lyrics !== void 0)
    patch.unsynchronisedLyrics = tags.lyrics === "" ? "" : { language: "chi", text: tags.lyrics };
  if (tags.cover !== void 0) {
    patch.image = tags.cover ? { mime: tags.cover.mime, type: { id: 3 }, description: "", imageBuffer: Buffer.from(tags.cover.data) } : void 0;
  }
  try {
    const updated = NodeID3.update(patch, Buffer.from(original));
    if (!(updated instanceof Uint8Array))
      return false;
...
async function readGenericTags(bytes) {
  ...
  if (isOgg) {
    ...
    if (ogg.title)
      out.title = ogg.title;
    if (ogg.artist)
      out.artist = ogg.artist;
    if (ogg.album)
      out.album = ogg.album;
    if (ogg.year)
      out.year = ogg.year;
    if (ogg.lyrics)
      out.lyrics = ogg.lyrics;
    return out;
  }
...
var HEADERS = { "User-Agent": UA, Referer: "https://music.163.com" };
var TIMEOUT_MS = 8e3;
...
function httpsGetJson(https, url) {
  return new Promise((resolve, reject) => {
    const u = new URL(url);
...
async function fetchJsonViaFetch(url) {
...
async function searchSong(query) {
  ...
  const songs = (_a = data.result) == null ? void 0 : _a.songs;
  ...
  return songs.map((s) => {
    ...
    return {
      ...
      artists: Array.isArray(raw.ar) ? raw.ar.map((a) => typeof a.name === "string" ? a.name : "") : [],
      album: raw.al && typeof raw.al.name === "string" ? raw.al.name : void 0,
      coverUrl: raw.al && typeof raw.al.picUrl === "string" ? raw.al.picUrl : void 0
    };
  });
}
...
function httpsGetBinary(https, url) {
  return new Promise((resolve) => {
    const u = new URL(url);
    const req = https.request(
      {
...
async function fetchLyric(songId) {
  ...
  if (data.nolyric)
    return null;
  const lyric = (_a = data.lrc) == null ? void 0 : _a.lyric;
  return typeof lyric === "string" && lyric.trim() ? lyric : null;
}
function pickBestMatch(songs, title, artist) {
  if (songs.length === 0)
    return null;
  ...
  for (const song of songs) {
    ...
    if (t && name === t)
      score += 10;
    else if (t && name && name.includes(t))
      score += 5;
    if (a) {
      if (song.artists.some((x) => clean(x) === a))
        score += 5;
      else if (song.artists.some((x) => x.toLowerCase().includes(a)))
        score += 2;
    }
    if (score > bestScore) {
      bestScore = score;
...
// src/TagEditorModal.ts
var TagEditorModal = class extends import_obsidian8.Modal {
  // 在线歌词获取中标志（防重复点击）
  ...
  async onOpen() {
    ...
    if (!this.source) {
      new import_obsidian8.Notice("\u672A\u627E\u5230\u8BE5\u6B4C\u66F2\u7684 MP3 \u6587\u4EF6");
      this.close();
      return;
    }
    ...
    if (!isMp3) {
      new import_obsidian8.Notice("\u4EC5 MP3 \u53EF\u7F16\u8F91\u6807\u7B7E\uFF0C\u8BE5\u683C\u5F0F\u4E3A\u53EA\u8BFB\u5C55\u793A", 4e3);
      this.close();
      return;
    }
  ...
  render() {
    ...
    contentEl.empty();
    const nameSetting = new import_obsidian8.Setting(contentEl).setName("\u6587\u4EF6\u540D").setDesc("\u91CD\u547D\u540D\u6587\u4EF6\uFF08vault \u5185\u81EA\u52A8\u66F4\u65B0\u5F15\u7528\uFF0C\u5E93\u5916\u540C\u6B65\u6539\u7B14\u8BB0 source \u884C\uFF09");
    ...
    for (const [key, label] of textFields) {
      new import_obsidian8.Setting(contentEl).setName(label).addText((text) => {
        var _a2;
    ...
    new import_obsidian8.Setting(contentEl).setName("\u6B4C\u8BCD").setDesc("\u53EF\u6574\u6BB5\u7C98\u8D34 LRC\uFF08\u542B [mm:ss] \u65F6\u95F4\u6233\uFF09\uFF0C\u4FDD\u5B58\u5199\u56DE USLT \u5E27");
    ...
    lyricsArea.addEventListener("input", () => {
      this.tags.lyrics = lyricsArea.value;
    });
    ...
    const coverSetting = new import_obsidian8.Setting(contentEl).setName("\u5C01\u9762");
    ...
    coverSetting.addButton((btn) => btn.setButtonText("\u9009\u62E9\u56FE\u7247").onClick(() => {
      var _a2;
      return (_a2 = this.coverInput) == null ? void 0 : _a2.click();
    }));
    ...
    this.coverInput.addEventListener("change", () => {
      ...
      reader.onload = () => {
        this.tags.cover = { mime: f.type || "image/jpeg", data: new Uint8Array(reader.result) };
        this.renderCoverPreview();
      };
      reader.readAsArrayBuffer(f);
    });
    const actions = contentEl.createDiv({ cls: "lyrics-tag-actions" });
    actions.createEl("button", { text: "\u53D6\u6D88", cls: "mod-cta lyrics-tag-cancel" }).addEventListener("click", () => this.close());
    actions.createEl("button", { text: "\u4FDD\u5B58", cls: "mod-cta lyrics-tag-save" }).addEventListener("click", () => this.save());
  }
  ...
  async searchCurrentSong() {
    ...
    if (!title) {
      new import_obsidian8.Notice("\u65E0\u6807\u9898\uFF0C\u65E0\u6CD5\u641C\u7D22");
      return null;
    }
    ...
    if (!match) {
      new import_obsidian8.Notice("\u672A\u627E\u5230\u5339\u914D\u7684\u6B4C\u66F2");
      return null;
    }
    return match;
  }
  /** 从网易云拉取当前歌曲歌词，导入歌词框（保存时写回 USLT） */
  async fetchOnlineLyrics(lyricsArea, btn) {
    if (this.fetching)
      return;
    this.fetching = true;
    ...
    try {
      ...
      if (!lrc) {
        new import_obsidian8.Notice("\u8BE5\u6B4C\u66F2\u65E0\u6B4C\u8BCD");
        return;
      }
      lyricsArea.value = lrc;
      this.tags.lyrics = lrc;
      const matchLabel = [match.name, ...match.artists].filter(Boolean).join(" - ");
      new import_obsidian8.Notice(`\u5DF2\u5BFC\u5165\u6B4C\u8BCD\uFF1A${matchLabel}`, 3e3);
    } catch (e) {
      new import_obsidian8.Notice(`\u83B7\u53D6\u6B4C\u8BCD\u5931\u8D25\uFF1A${e.message || "\u7F51\u7EDC\u9519\u8BEF"}`, 5e3);
    } finally {
      this.fetching = false;
  ...
  async fetchCover(btn) {
    ...
    try {
      ...
      if (!match)
        return;
      if (!match.coverUrl) {
        new import_obsidian8.Notice("\u8BE5\u6B4C\u66F2\u65E0\u5C01\u9762");
        return;
      }
      const img = await downloadImage(match.coverUrl);
      if (!img) {
        new import_obsidian8.Notice("\u5C01\u9762\u4E0B\u8F7D\u5931\u8D25");
        return;
      }
      this.tags.cover = img;
      this.renderCoverPreview();
      const matchLabel = [match.name, ...match.artists].filter(Boolean).join(" - ");
      new import_obsidian8.Notice(`\u5DF2\u5BFC\u5165\u5C01\u9762\uFF1A${matchLabel}`, 3e3);
    } catch (e) {
      new import_obsidian8.Notice(`\u83B7\u53D6\u5C01\u9762\u5931\u8D25\uFF1A${e.message || "\u7F51\u7EDC\u9519\u8BEF"}`, 5e3);
    } finally {
      this.fetching = false;
      btn.setDisabled(false);
  ...
  getCurrentFileName() {
    ...
    if (this.source.type === "external" && this.source.path) {
      return (_a = this.source.path.split(/[\\/]/).pop()) != null ? _a : "";
    }
    return "";
  }
  renderCoverPreview() {
  ...
  async save() {
    var _a, _b, _c;
    if (this.saving || !this.source)
      return;
    this.saving = true;
    try {
      const ok = await writeMp3Tags(this.app, this.source, this.tags);
      if (!ok) {
        new import_obsidian8.Notice("\u4FDD\u5B58\u5931\u8D25\uFF0C\u5DF2\u8FD8\u539F\u539F\u6587\u4EF6", 5e3);
        return;
      }
      const renamed = await this.renameAudioFile();
      if (!renamed) {
        new import_obsidian8.Notice("\u6807\u7B7E\u5DF2\u4FDD\u5B58\uFF0C\u4F46\u6587\u4EF6\u540D\u91CD\u547D\u540D\u5931\u8D25\uFF08\u6807\u7B7E\u5DF2\u5199\u5165\u539F\u6587\u4EF6\uFF09", 5e3);
        return;
      }
      new import_obsidian8.Notice("\u4FDD\u5B58\u6210\u529F");
  ...
  async renameAudioFile() {
    if (!this.source || !this.newFileName || !this.newFileName.includes("."))
      return true;
    const current = this.getCurrentFileName();
    if (this.newFileName === current)
      return true;
    if (this.source.type === "vault" && this.source.file) {
      ...
      try {
        ...
        this.source.file = this.app.vault.getAbstractFileByPath(newPath);
        return true;
      } catch (e) {
        return false;
      }
  ...
  async updateNoteSourceLine(oldPath, newPath) {
    ...
    try {
      ...
      for (let i = 0; i < lines.length; i++) {
        ...
        if (((_a = m == null ? void 0 : m.groups) == null ? void 0 : _a.audio) === oldPath) {
...
var TagViewerModal = class extends import_obsidian9.Modal {
  ...
  async onOpen() {
    ...
    if (!this.source) {
      new import_obsidian9.Notice("\u672A\u627E\u5230\u97F3\u9891\u6587\u4EF6");
      this.close();
      return;
    }
    let bytes = null;
    ...
    if (!bytes) {
      new import_obsidian9.Notice("\u8BFB\u53D6\u6807\u7B7E\u5931\u8D25", 4e3);
      this.close();
      return;
    }
  ...
  render(tags) {
    ...
    new import_obsidian9.Setting(this.contentEl).setName("\u6807\u9898").setDesc(t.title || "\uFF08\u65E0\uFF09");
    new import_obsidian9.Setting(this.contentEl).setName("\u827A\u672F\u5BB6").setDesc(t.artist || "\uFF08\u65E0\uFF09");
    new import_obsidian9.Setting(this.contentEl).setName("\u4E13\u8F91").setDesc(t.album || "\uFF08\u65E0\uFF09");
    new import_obsidian9.Setting(this.contentEl).setName("\u6B4C\u8BCD").setDesc("\u53EA\u8BFB\u5C55\u793A\uFF0C\u5982\u9700\u4FEE\u6539\u8BF7\u7528\u5916\u90E8\u5DE5\u5177\u7F16\u8F91\u6807\u7B7E");
    const lyricsArea = this.contentEl.createEl("textarea", {
      cls: "lyrics-tag-lyrics"
    });
    lyricsArea.value = t.lyrics || "";
    lyricsArea.readOnly = true;
    new import_obsidian9.Setting(this.contentEl).setName("\u5C01\u9762");
    if (t.cover) {
    ...
    actions.createEl("button", { text: "\u5173\u95ED", cls: "mod-cta lyrics-tag-cancel" }).addEventListener("click", () => this.close());
  }
  onClose() {
    this.contentEl.empty();
  }
...
// src/LyricsView.ts
var LyricsView = class extends import_obsidian10.ItemView {
  constructor(leaf, plugin) {
    ...
    this.songCoverUrls = /* @__PURE__ */ new Map();
    // song.path → 音频封面 blob URL
  ...
  updatePlayPauseIcon(isPlaying) {
    ...
    (0, import_obsidian10.setIcon)(icon, isPlaying ? "pause" : "play");
  }
  // --- Status bar ---
  createStatusBar(container) {
    ...
    (0, import_obsidian10.setIcon)(this.statusBarPlay, "play");
    ...
    (0, import_obsidian10.setIcon)(this.statusBarLocate, "locate-fixed");
  ...
  renderModeIcon() {
    ...
    (0, import_obsidian10.setIcon)(this.statusBarMode, icon);
    const titles = {
      off: "\u64AD\u653E\u6A21\u5F0F\uFF1A\u5173\u95ED",
      single: "\u64AD\u653E\u6A21\u5F0F\uFF1A\u5355\u66F2\u5FAA\u73AF",
  ...
  renderVolumeIcon() {
    ...
    (0, import_obsidian10.setIcon)(this.statusBarVolumeIcon, icon);
  ...
  renderStatusBar(state) {
    ...
    (0, import_obsidian10.setIcon)(this.statusBarPlay, state.isPlaying ? "pause" : "play");
  ...
  locateLyricsNote() {
    ...
    if ((state == null ? void 0 : state.sourceKind) === "mp3") {
      if (!this.songListPopup)
  ...
  scrollPopupToActive() {
    if (!this.songListPopup)
      return;
    const list = this.songListPopup.querySelector(".lyrics-song-popup-list");
    const active = this.songListPopup.querySelector(".lyrics-songs-item-active");
    if (list && active) {
  ...
  renderLyricsFull(state) {
    ...
    state.lyrics.forEach((line, index) => {
      ...
      if (isCurrent)
        this.currentHighlightedEls.push(lineEl);
  ...
  keepCurrentLineVisible(force = false) {
    var _a;
    const panel = this.lyricsEl;
    const line = (_a = this.currentHighlightedEls[0]) != null ? _a : null;
    if (!panel || !line)
      return;
  ...
  updateKaraokeWords(state) {
    const timeMs = Math.round(state.currentTime * 1e3);
    for (const lineEl of this.currentHighlightedEls) {
      const words = lineEl.querySelectorAll(".lyrics-panel-word, .lyrics-panel-word-active");
      words.forEach((word) => {
  ...
  renderPopupSongList() {
    ...
    songs.forEach((song) => {
      var _a2;
      const isActive = ((_a2 = state == null ? void 0 : state.filePath) == null ? void 0 : _a2.replace(/^mp3:\/\//, "")) === song.path;
      ...
      if (bannerUrl) {
        ...
        (0, import_obsidian10.setIcon)(thumb, "music");
      }
      if (song.kind === "note" || /\.mp3$/i.test(song.path)) {
        ...
        editBtn.addEventListener("click", (e) => {
          ...
          if (song.kind === "mp3") {
            ...
            const src = file instanceof import_obsidian10.TFile ? { type: "vault", file } : null;
            if (src)
              new TagEditorModal(this.plugin.app, this.plugin, "", src).open();
          } else {
        ...
        (0, import_obsidian10.setIcon)(viewBtn, "eye");
  ...
  closeSongListPopup() {
    ...
    this.songListCountEl = null;
    for (const url of this.songCoverUrls.values())
  ...
  getAudioCoverUrl(song) {
    ...
    if (!audioCover)
      return "";
    let url = (_a = this.songCoverUrls.get(song.path)) != null ? _a : "";
    if (!url) {
...
// src/main.ts
var LyricsPlugin = class extends import_obsidian11.Plugin {
  constructor() {
    super(...arguments);
    this.state = null;
    this.stateListeners = [];
    ...
    this.shuffleQueue = [];
    /** 音频标签缓存：key = 音频路径 */
    this.audioTagCache = /* @__PURE__ */ new Map();
    this._playMode = "off";
  ...
  onRendererPaused(path) {
    ...
    const self2 = this.activeRenderers.get(path);
    self2 == null ? void 0 : self2.emitState();
  }
  /** 播放时由渲染器上报：接管状态源并暂停其他所有渲染器（单音轨不变量，避免手动播放 LRC 笔记与裸 MP3 双音轨） */
  markPlayerActive(path) {
    if (path !== this.lastActiveRenderPath && this.lastActiveRenderPath) {
      ...
      this.previousWasPlaying = (prev == null ? void 0 : prev.player) ? !prev.player.paused() : false;
    }
  ...
  onRendererUnloaded(path) {
    var _a;
    const isDisplay = ((_a = this.getLyricsState()) == null ? void 0 : _a.filePath) === path;
    if (!isDisplay && this.lastActiveRenderPath !== path)
      return;
    ...
    if (prevRenderer == null ? void 0 : prevRenderer.player) {
      if (wasPlayed && wasPlaying && prevRenderer.player.paused())
        prevRenderer.player.play();
  ...
  getActivePlayer() {
    ...
    if (playing == null ? void 0 : playing.player)
      return playing.player;
  ...
  async advanceToMp3(song) {
    ...
    const target = (_a = this.activeRenderers.get(render.path)) == null ? void 0 : _a.player;
  ...
  async scanLyricSongs() {
    ...
    if (source === "audio") {
      ...
      if (audioFolder) {
        ...
        const mp3Songs = allFiles.filter((f) => f.path.startsWith(audioPrefix) && isAudioFile(f.path)).map((f) => buildMp3Song(f.path));
        songs.push(...mp3Songs);
      }
    } else {
    ...
    this.shuffleQueue = [];
    this.audioTagCache.clear();
    const currentPath = (_b = (_a = this.lastActiveRenderPath) == null ? void 0 : _a.replace(/^mp3:\/\//, "")) != null ? _b : null;
    const currentStillInList = currentPath ? this.songList.some((s) => s.path === currentPath) : true;
    if (!currentStillInList) {
      await this.stopAllPlayback();
    }
    const playingState = this.getLyricsState();
    if ((playingState == null ? void 0 : playingState.sourceKind) === "mp3" && playingState.filePath) {
  ...
  async enrichSongList() {
    ...
    if (mySeq === this.enrichSeq) {
      const noteAudioPaths = new Set(
        this.songList.filter((s) => s.kind === "note" && s.audioPath).map((s) => s.audioPath)
      );
      this.songList = [
  ...
  async enrichOne(song) {
    ...
    let src = null;
    if (song.kind === "mp3") {
      key = (_a = song.audioPath) != null ? _a : "";
      if (!key || this.audioTagCache.has(key))
        return;
      ...
      key = src.type === "external" ? src.path : (_c = (_b = src.file) == null ? void 0 : _b.path) != null ? _c : "";
      song.audioPath = key;
    }
    if (!key || this.audioTagCache.has(key))
      return;
    ...
    if (song.kind === "mp3") {
      ...
      if (tags == null ? void 0 : tags.artist)
        song.actor = tags.artist;
      if (tags == null ? void 0 : tags.album)
        song.type = tags.album;
    }
  }
  /** 标签编辑/重扫后同步正在播放的裸 MP3 元数据到渲染器，使状态栏标题/作者实时刷新 */
  syncPlayingMp3Metadata() {
  ...
  getAudioCover(song) {
    ...
    if (!song.audioPath)
      return null;
    return (_b = (_a = this.audioTagCache.get(song.audioPath)) == null ? void 0 : _a.cover) != null ? _b : null;
  }
  /** 供弹窗保存后刷新列表（清除该歌缓存 + 重新扫描）；编辑的是正在播放的裸 MP3 时实时重读内嵌歌词 */
  notifyTagsEdited(notePath) {
    const song = this.songList.find((s) => s.path === notePath);
    if (song == null ? void 0 : song.audioPath)
      this.audioTagCache.delete(song.audioPath);
    const state = this.getLyricsState();
    if ((state == null ? void 0 : state.sourceKind) === "mp3" && state.filePath === `mp3://${notePath}`) {
  ...
  async onload() {
    ...
    this._playbackRate = (_a = this.getSettings().playbackRate) != null ? _a : 1;
    this._volume = (_b = this.getSettings().volume) != null ? _b : 75;
    ...
    this.registerEvent(this.app.workspace.on("active-leaf-change", () => {
      if (this.leafChangeTimer !== null)
        clearTimeout(this.leafChangeTimer);
      this.leafChangeTimer = window.setTimeout(() => {
        this.leafChangeTimer = null;
        const activeFile = this.app.workspace.getActiveFile();
        const playingRenderer = this.lastActiveRenderPath ? this.activeRenderers.get(this.lastActiveRenderPath) : null;
